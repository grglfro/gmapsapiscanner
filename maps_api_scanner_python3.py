...
def scan_gmaps(apikey):
	...
	headers = {'Referer': 'https://www.example.com/exampletext'}
	...
	headers = {'Referer': 'https://www.example.com/exampletext'}
	response = requests.post(url, data=postdata, verify=False, headers={'Referer': 'https://www.example.com/exampletext', 'Content-Type':'application/json','Authorization':'key='+apikey})
	if response.status_code == 200:
